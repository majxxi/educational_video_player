    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center p-4">
      <div className="text-center">
        <div className="mb-8">
          ...
          <h1 className="text-6xl font-bold text-white mb-4">Majick's Educational Video Player</h1>
          <p className="text-xl text-gray-300 mb-8">Stream Educational Videos</p>
        </div>
        <Button
